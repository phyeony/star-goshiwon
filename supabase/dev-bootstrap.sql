...
('5044b1be-9895-48d3-a323-2b15760ebe23', 'Private Shower Room', 'room-with-private-shower', 'A private room with your own shower and access to a shared toilet. A smart choice for guests who want extra convenience at a reasonable price. Includes an outside-facing window, fast Wi-Fi, AC/heating, a desk, and a mini fridge.', 408000, 120000, 18000, 1, 6.5, ARRAY['Private Shower','Shared Toilet','AC / Heat','Fast WiFi','Desk & Chair','Mini Fridge','Shelf & Cabinet','Outside-Facing Window'], 'available', NULL, true, 2),
